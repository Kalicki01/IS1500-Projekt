...
void display_image(int x, const uint8_t *data) {
	...
	for(i = 0; i < 4; i++) { // Guess the 4 stands for the 4 different segments that is displayed on our OLED-Display
		DISPLAY_CHANGE_TO_COMMAND_MODE;
		...
		for(j = 0; j < 128; j++) // We iterate trough 128 horizontal bits, for each segment (0,1,2,3)
